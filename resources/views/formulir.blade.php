...
<body>
    <div class="container mt-4">
        <div class="alert text-center bg-dark" style=" color:#fff;" role="alert">
            Form Peminjaman Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur vel unde cumque perferendis fugiat nihil sint. Suscipit eveniet possimus quibusdam odit, maiores earum molestiae magni nam neque doloremque voluptatibus animi!
          </div>
          {{-- <div class="alert bg-success mt-3">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ab, excepturi consequatur? Itaque vitae deserunt pariatur excepturi quae eum natus eveniet aperiam porro corporis, quam accusantium incidunt impedit consequatur doloremque voluptatibus.
          </div> --}}
